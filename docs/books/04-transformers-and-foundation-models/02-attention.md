...
Every chapter lab pairs reading with **executable acceptance**. Before implementing book 4.2 — attention:

1. Draft cases in `test_lab.py` or `specs/lab-0402.yaml`.
2. Use [Cursor Plan/Agent](https://cursor.com/) with "read spec first, then minimal diff".
3. Or use [OpenSpec](https://openspec.dev/) `/opsx:propose` so requirements live in `openspec/` next to code.

→ [Spec-driven workflow guide](../../getting-started/spec-driven-workflow.md) · [Lab 4.2](../../labs/0402-attention.md)
