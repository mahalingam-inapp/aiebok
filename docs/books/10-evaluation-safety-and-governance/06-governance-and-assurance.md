...
Every chapter lab pairs reading with **executable acceptance**. Before implementing book 10.6 — governance and assurance:

1. Draft cases in `test_lab.py` or `specs/lab-1006.yaml`.
2. Use [Cursor Plan/Agent](https://cursor.com/) with "read spec first, then minimal diff".
3. Or use [OpenSpec](https://openspec.dev/) `/opsx:propose` so requirements live in `openspec/` next to code.

→ [Spec-driven workflow guide](../../getting-started/spec-driven-workflow.md) · [Lab 10.6](../../labs/1006-governance-and-assurance.md)
