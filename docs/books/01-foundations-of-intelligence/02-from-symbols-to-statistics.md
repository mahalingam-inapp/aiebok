...
- Explain the problem that motivated from symbols to statistics.
...
|---|---|---|
| **Symbolic Ai** | establishes the first representation or decision boundary | Define inputs and outputs; construct a minimal example; identify one invalid assumption. |
| **Expert Systems** | adds the main transformation or comparison | Define inputs and outputs; construct a minimal example; identify one invalid assumption. |
| **Knowledge Representation** | connects the mechanism to the surrounding system | Define inputs and outputs; construct a minimal example; identify one invalid assumption. |
| **Statistical Learning** | controls quality, efficiency, or behavior | Define inputs and outputs; construct a minimal example; identify one invalid assumption. |
| **Deep Learning** | exposes an important operating constraint or failure mode | Define inputs and outputs; construct a minimal example; identify one invalid assumption. |
## Worked example

**Book scenario:** A support team must route incidents without mistaking fluent descriptions for reliable decisions.

**Chapter focus:** Trace the path from symbolic rules and expert systems to statistical learning, deep learning, foundation models, and agents. Each era solved different problems and retained useful ideas.
...
2. Locate where symbolic AI and expert systems enter the book-level visual above.
...
The design question is: **What evidence would show that from symbols to statistics addresses this chapter's problem better than the baseline?** Answer with measured observations rather than intuition alone.
...
1. What problem would remain if symbolic AI were removed from the system?
2. Which observation would distinguish a failure in expert systems from a failure in deep learning?
