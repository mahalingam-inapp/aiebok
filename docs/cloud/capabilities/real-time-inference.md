...
|---|---|
| AWS | SageMaker real-time endpoints, Bedrock InvokeModel |
| Azure | Azure ML managed online endpoints, Azure OpenAI |
| Google Cloud | Vertex online prediction, Cloud Run + GPU |
