...
1. **JSON Schema** — deliverable and acceptance check
2. **Validator** — deliverable and acceptance check
3. **Repair loop** — deliverable and acceptance check
4. **Adversarial tests** — deliverable and acceptance check
