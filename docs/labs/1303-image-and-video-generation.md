...
Design an evaluation rubric for generated campaign assets.

## Prerequisites

Book [Multimodal and Frontier Systems](../books/13-multimodal-and-frontier-systems/index.md), chapter 3.

## Run

```bash
python labs/1303-image-and-video-generation/main.py
python -m pytest labs/1303-image-and-video-generation/test_lab.py -q
```
...
1. **Write cases first** — Before changing `main.py`, write **three acceptance cases** for *Image and Video Generation* (normal, boundary, adversarial) in `specs/lab-1303.yaml` or as pytest cases in `test_lab.py`. Goal: Design an evaluation rubric for generated campaign assets.
...
```text
Read specs/lab-1303.yaml (or test_lab.py cases).
...
```text
/opsx:propose Add acceptance spec for lab 13.3 — Image and Video Generation
```
...
```text
/opsx:apply
python -m pytest labs/1303-*/test_lab.py -q
/opsx:archive
```
