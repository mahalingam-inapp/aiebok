...
Write a one-page frontier assessment with confidence levels.

## Prerequisites

Book [Multimodal and Frontier Systems](../books/13-multimodal-and-frontier-systems/index.md), chapter 6.

## Run

```bash
python labs/1306-how-to-track-the-frontier/main.py
python -m pytest labs/1306-how-to-track-the-frontier/test_lab.py -q
```
...
1. **Write cases first** — Before changing `main.py`, write **three acceptance cases** for *How to Track the Frontier* (normal, boundary, adversarial) in `specs/lab-1306.yaml` or as pytest cases in `test_lab.py`. Goal: Write a one-page frontier assessment with confidence levels.
...
```text
Read specs/lab-1306.yaml (or test_lab.py cases).
...
```text
/opsx:propose Add acceptance spec for lab 13.6 — How to Track the Frontier
```
...
```text
/opsx:apply
python -m pytest labs/1306-*/test_lab.py -q
/opsx:archive
```
