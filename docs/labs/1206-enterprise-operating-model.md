...
Create a responsibility matrix and platform roadmap.

## Prerequisites

Book [Cloud and Enterprise AI Architecture](../books/12-cloud-and-enterprise-ai-architecture/index.md), chapter 6.

## Run

```bash
python labs/1206-enterprise-operating-model/main.py
python -m pytest labs/1206-enterprise-operating-model/test_lab.py -q
```
...
1. **Write cases first** — Before changing `main.py`, write **three acceptance cases** for *Enterprise Operating Model* (normal, boundary, adversarial) in `specs/lab-1206.yaml` or as pytest cases in `test_lab.py`. Goal: Create a responsibility matrix and platform roadmap.
...
```text
Read specs/lab-1206.yaml (or test_lab.py cases).
...
```text
/opsx:propose Add acceptance spec for lab 12.6 — Enterprise Operating Model
```
...
```text
/opsx:apply
python -m pytest labs/1206-*/test_lab.py -q
/opsx:archive
```
