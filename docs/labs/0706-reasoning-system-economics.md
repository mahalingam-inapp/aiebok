...
Plot quality and cost for single-pass, best-of-N, and verifier loops.

## Prerequisites

Book [Reasoning and Tool Use](../books/07-reasoning-and-tool-use/index.md), chapter 6.

## Run

```bash
python labs/0706-reasoning-system-economics/main.py
python -m pytest labs/0706-reasoning-system-economics/test_lab.py -q
```
...
1. **Write cases first** — Before changing `main.py`, write **three acceptance cases** for *Reasoning-System Economics* (normal, boundary, adversarial) in `specs/lab-0706.yaml` or as pytest cases in `test_lab.py`. Goal: Plot quality and cost for single-pass, best-of-N, and verifier loops.
...
```text
Read specs/lab-0706.yaml (or test_lab.py cases).
...
```text
/opsx:propose Add acceptance spec for lab 7.6 — Reasoning-System Economics
```
...
```text
/opsx:apply
python -m pytest labs/0706-*/test_lab.py -q
/opsx:archive
```
