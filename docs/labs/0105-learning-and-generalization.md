...
Fit increasingly flexible models to a small noisy dataset and plot errors.

## Prerequisites

Book [Foundations of Intelligence](../books/01-foundations-of-intelligence/index.md), chapter 5.

## Run

```bash
python labs/0105-learning-and-generalization/main.py
python -m pytest labs/0105-learning-and-generalization/test_lab.py -q
```
...
1. **Write cases first** — Before changing `main.py`, write **three acceptance cases** for *Learning and Generalization* (normal, boundary, adversarial) in `specs/lab-0105.yaml` or as pytest cases in `test_lab.py`. Goal: Fit increasingly flexible models to a small noisy dataset and plot errors.
...
```text
Read specs/lab-0105.yaml (or test_lab.py cases).
...
```text
/opsx:propose Add acceptance spec for lab 1.5 — Learning and Generalization
```
...
```text
/opsx:apply
python -m pytest labs/0105-*/test_lab.py -q
/opsx:archive
```
