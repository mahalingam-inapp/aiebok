...
Implement lexical and vector baselines and calculate recall@k.

## Prerequisites

Book [Knowledge and Retrieval Systems](../books/06-knowledge-and-retrieval-systems/index.md), chapter 3.

## Run

```bash
python labs/0603-retrieval/main.py
python -m pytest labs/0603-retrieval/test_lab.py -q
```
...
1. **Write cases first** — Before changing `main.py`, write **three acceptance cases** for *Retrieval* (normal, boundary, adversarial) in `specs/lab-0603.yaml` or as pytest cases in `test_lab.py`. Goal: Implement lexical and vector baselines and calculate recall@k.
...
```text
Read specs/lab-0603.yaml (or test_lab.py cases).
...
```text
/opsx:propose Add acceptance spec for lab 6.3 — Retrieval
```
...
```text
/opsx:apply
python -m pytest labs/0603-*/test_lab.py -q
/opsx:archive
```
