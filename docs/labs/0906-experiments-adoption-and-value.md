...
Design a rollout with guardrails and decision thresholds.

## Prerequisites

Book [AI Software and Product Engineering](../books/09-ai-software-and-product-engineering/index.md), chapter 6.

## Run

```bash
python labs/0906-experiments-adoption-and-value/main.py
python -m pytest labs/0906-experiments-adoption-and-value/test_lab.py -q
```
...
1. **Write cases first** — Before changing `main.py`, write **three acceptance cases** for *Experiments, Adoption, and Value* (normal, boundary, adversarial) in `specs/lab-0906.yaml` or as pytest cases in `test_lab.py`. Goal: Design a rollout with guardrails and decision thresholds.
...
```text
Read specs/lab-0906.yaml (or test_lab.py cases).
...
```text
/opsx:propose Add acceptance spec for lab 9.6 — Experiments, Adoption, and Value
```
...
```text
/opsx:apply
python -m pytest labs/0906-*/test_lab.py -q
/opsx:archive
```
