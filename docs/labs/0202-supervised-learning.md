...
Implement linear and logistic regression before using a library.

## Prerequisites

Book [Machine Learning Systems](../books/02-machine-learning-systems/index.md), chapter 2.

## Run

```bash
python labs/0202-supervised-learning/main.py
python -m pytest labs/0202-supervised-learning/test_lab.py -q
```
...
1. **Write cases first** — Before changing `main.py`, write **three acceptance cases** for *Supervised Learning* (normal, boundary, adversarial) in `specs/lab-0202.yaml` or as pytest cases in `test_lab.py`. Goal: Implement linear and logistic regression before using a library.
...
```text
Read specs/lab-0202.yaml (or test_lab.py cases).
...
```text
/opsx:propose Add acceptance spec for lab 2.2 — Supervised Learning
```
...
```text
/opsx:apply
python -m pytest labs/0202-*/test_lab.py -q
/opsx:archive
```
