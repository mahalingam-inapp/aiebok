...
**Purpose:** Backpropagation applies the chain rule to compute gradients through layered computations efficiently.

**Prerequisites:** See related concepts and book chapters linked from the [concept card](cards/backpropagation.md).
...
1. Define the decision or system stage where backpropagation applies.
...
Run `python labs/0204-neural-networks/main.py` from the repository root.
...
Backpropagation improves some outcomes but adds complexity, latency, or operational burden. Compare against simpler alternatives on *your* workload before adopting by default.
