...
**Purpose:** Canaries route small traffic percentage to new versions before full rollout.

**Prerequisites:** See related concepts and book chapters linked from the [concept card](cards/canaries.md).
...
1. Define the decision or system stage where canaries applies.
...
Canaries improves some outcomes but adds complexity, latency, or operational burden. Compare against simpler alternatives on *your* workload before adopting by default.
