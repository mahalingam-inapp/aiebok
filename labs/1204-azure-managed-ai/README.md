...
- Book 12: Cloud and Enterprise AI Architecture, chapter 4
- Python 3.10+
...
1. **Write cases first** — Before changing `main.py`, write **three acceptance cases** for *Azure Managed AI* (normal, boundary, adversarial) in `specs/lab-1204.yaml` or as pytest cases in `test_lab.py`. Goal: Map the same RAG design to Azure and compare identity integration.
...
```text
Read specs/lab-1204.yaml (or test_lab.py cases).
...
```text
/opsx:propose Add acceptance spec for lab 12.4 — Azure Managed AI
```
...
```text
/opsx:apply
python -m pytest labs/1204-*/test_lab.py -q
/opsx:archive
```
