...
- Book 10: Evaluation, Safety, and Governance, chapter 2
- Python 3.10+
...
1. **Write cases first** — Before changing `main.py`, write **three acceptance cases** for *Metrics and Human Judgment* (normal, boundary, adversarial) in `specs/lab-1002.yaml` or as pytest cases in `test_lab.py`. Goal: Calibrate an automated judge against two human reviewers.
...
```text
Read specs/lab-1002.yaml (or test_lab.py cases).
...
```text
/opsx:propose Add acceptance spec for lab 10.2 — Metrics and Human Judgment
```
...
```text
/opsx:apply
python -m pytest labs/1002-*/test_lab.py -q
/opsx:archive
```
