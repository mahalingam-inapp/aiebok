...
- Book 6: Knowledge and Retrieval Systems, chapter 6
- Python 3.10+
...
1. **Write cases first** — Before changing `main.py`, write **three acceptance cases** for *Advanced and Enterprise RAG* (normal, boundary, adversarial) in `specs/lab-0606.yaml` or as pytest cases in `test_lab.py`. Goal: Complete the enterprise RAG architecture studio and threat model.
...
```text
Read specs/lab-0606.yaml (or test_lab.py cases).
...
```text
/opsx:propose Add acceptance spec for lab 6.6 — Advanced and Enterprise RAG
```
...
```text
/opsx:apply
python -m pytest labs/0606-*/test_lab.py -q
/opsx:archive
```
