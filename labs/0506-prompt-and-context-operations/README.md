...
- Book 5: Prompt and Context Engineering, chapter 6
- Python 3.10+
...
1. **Write cases first** — Before changing `main.py`, write **three acceptance cases** for *Prompt and Context Operations* (normal, boundary, adversarial) in `specs/lab-0506.yaml` or as pytest cases in `test_lab.py`. Goal: Create a prompt change report with before/after evals.
...
```text
Read specs/lab-0506.yaml (or test_lab.py cases).
...
```text
/opsx:propose Add acceptance spec for lab 5.6 — Prompt and Context Operations
```
...
```text
/opsx:apply
python -m pytest labs/0506-*/test_lab.py -q
/opsx:archive
```
