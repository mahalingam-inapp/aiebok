...
- Book 10: Evaluation, Safety, and Governance, chapter 5
- Python 3.10+
...
1. **Write cases first** — Before changing `main.py`, write **three acceptance cases** for *Responsible AI and Risk* (normal, boundary, adversarial) in `specs/lab-1005.yaml` or as pytest cases in `test_lab.py`. Goal: Write an impact assessment for a consequential use case.
...
```text
Read specs/lab-1005.yaml (or test_lab.py cases).
...
```text
/opsx:propose Add acceptance spec for lab 10.5 — Responsible AI and Risk
```
...
```text
/opsx:apply
python -m pytest labs/1005-*/test_lab.py -q
/opsx:archive
```
