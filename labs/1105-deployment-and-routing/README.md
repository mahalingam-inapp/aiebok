...
- Book 11: Training, Serving, and AI Operations, chapter 5
- Python 3.10+
...
1. **Write cases first** — Before changing `main.py`, write **three acceptance cases** for *Deployment and Routing* (normal, boundary, adversarial) in `specs/lab-1105.yaml` or as pytest cases in `test_lab.py`. Goal: Write a deployment ADR comparing hosted and self-hosted inference.
...
```text
Read specs/lab-1105.yaml (or test_lab.py cases).
...
```text
/opsx:propose Add acceptance spec for lab 11.5 — Deployment and Routing
```
...
```text
/opsx:apply
python -m pytest labs/1105-*/test_lab.py -q
/opsx:archive
```
