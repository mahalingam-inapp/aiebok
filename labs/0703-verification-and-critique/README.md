...
- Book 7: Reasoning and Tool Use, chapter 3
- Python 3.10+
...
1. **Write cases first** — Before changing `main.py`, write **three acceptance cases** for *Verification and Critique* (normal, boundary, adversarial) in `specs/lab-0703.yaml` or as pytest cases in `test_lab.py`. Goal: Generate several candidates and select with an independent verifier.
...
```text
Read specs/lab-0703.yaml (or test_lab.py cases).
...
```text
/opsx:propose Add acceptance spec for lab 7.3 — Verification and Critique
```
...
```text
/opsx:apply
python -m pytest labs/0703-*/test_lab.py -q
/opsx:archive
```
