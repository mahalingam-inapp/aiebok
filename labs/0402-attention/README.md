...
- Book 4: Transformers and Foundation Models, chapter 2
- Python 3.10+
...
1. **Write cases first** — Before changing `main.py`, write **three acceptance cases** for *Attention* (normal, boundary, adversarial) in `specs/lab-0402.yaml` or as pytest cases in `test_lab.py`. Goal: Implement scaled dot-product attention and visualize weights.
...
```text
Read specs/lab-0402.yaml (or test_lab.py cases).
...
```text
/opsx:propose Add acceptance spec for lab 4.2 — Attention
```
...
```text
/opsx:apply
python -m pytest labs/0402-*/test_lab.py -q
/opsx:archive
```
