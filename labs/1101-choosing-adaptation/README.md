...
- Book 11: Training, Serving, and AI Operations, chapter 1
- Python 3.10+
...
1. **Write cases first** — Before changing `main.py`, write **three acceptance cases** for *Choosing Adaptation* (normal, boundary, adversarial) in `specs/lab-1101.yaml` or as pytest cases in `test_lab.py`. Goal: Create a decision table for ten adaptation scenarios.
...
```text
Read specs/lab-1101.yaml (or test_lab.py cases).
...
```text
/opsx:propose Add acceptance spec for lab 11.1 — Choosing Adaptation
```
...
```text
/opsx:apply
python -m pytest labs/1101-*/test_lab.py -q
/opsx:archive
```
