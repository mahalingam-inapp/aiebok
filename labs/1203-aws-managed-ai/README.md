...
- Book 12: Cloud and Enterprise AI Architecture, chapter 3
- Python 3.10+
...
1. **Write cases first** — Before changing `main.py`, write **three acceptance cases** for *AWS Managed AI* (normal, boundary, adversarial) in `specs/lab-1203.yaml` or as pytest cases in `test_lab.py`. Goal: Map the enterprise RAG design to AWS and estimate managed-service trade-offs.
...
```text
Read specs/lab-1203.yaml (or test_lab.py cases).
...
```text
/opsx:propose Add acceptance spec for lab 12.3 — AWS Managed AI
```
...
```text
/opsx:apply
python -m pytest labs/1203-*/test_lab.py -q
/opsx:archive
```
