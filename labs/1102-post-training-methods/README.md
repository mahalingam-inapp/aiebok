...
- Book 11: Training, Serving, and AI Operations, chapter 2
- Python 3.10+
...
1. **Write cases first** — Before changing `main.py`, write **three acceptance cases** for *Post-Training Methods* (normal, boundary, adversarial) in `specs/lab-1102.yaml` or as pytest cases in `test_lab.py`. Goal: Fine-tune a small model and evaluate held-out behavior.
...
```text
Read specs/lab-1102.yaml (or test_lab.py cases).
...
```text
/opsx:propose Add acceptance spec for lab 11.2 — Post-Training Methods
```
...
```text
/opsx:apply
python -m pytest labs/1102-*/test_lab.py -q
/opsx:archive
```
