...
- Book 10: Evaluation, Safety, and Governance, chapter 1
- Python 3.10+
...
1. **Write cases first** — Before changing `main.py`, write **three acceptance cases** for *Evaluation as Requirements* (normal, boundary, adversarial) in `specs/lab-1001.yaml` or as pytest cases in `test_lab.py`. Goal: Write a 30-case evaluation set from real workflow risks.
...
```text
Read specs/lab-1001.yaml (or test_lab.py cases).
...
```text
/opsx:propose Add acceptance spec for lab 10.1 — Evaluation as Requirements
```
...
```text
/opsx:apply
python -m pytest labs/1001-*/test_lab.py -q
/opsx:archive
```
