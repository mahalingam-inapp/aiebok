...
- Book 10: Evaluation, Safety, and Governance, chapter 4
- Python 3.10+
...
1. **Write cases first** — Before changing `main.py`, write **three acceptance cases** for *Security of AI Systems* (normal, boundary, adversarial) in `specs/lab-1004.yaml` or as pytest cases in `test_lab.py`. Goal: Red-team a tool-enabled assistant and document mitigations.
...
```text
Read specs/lab-1004.yaml (or test_lab.py cases).
...
```text
/opsx:propose Add acceptance spec for lab 10.4 — Security of AI Systems
```
...
```text
/opsx:apply
python -m pytest labs/1004-*/test_lab.py -q
/opsx:archive
```
