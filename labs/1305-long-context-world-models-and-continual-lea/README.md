...
- Book 13: Multimodal and Frontier Systems, chapter 5
- Python 3.10+
...
1. **Write cases first** — Before changing `main.py`, write **three acceptance cases** for *Long Context, World Models, and Continual Learning* (normal, boundary, adversarial) in `specs/lab-1305.yaml` or as pytest cases in `test_lab.py`. Goal: Compare a frontier method with retrieval, explicit state, or fine-tuning baselines.
...
```text
Read specs/lab-1305.yaml (or test_lab.py cases).
...
```text
/opsx:propose Add acceptance spec for lab 13.5 — Long Context, World Models, and Continual Learning
```
...
```text
/opsx:apply
python -m pytest labs/1305-*/test_lab.py -q
/opsx:archive
```
