...
- Book 9: AI Software and Product Engineering, chapter 4
- Python 3.10+
...
1. **Write cases first** — Before changing `main.py`, write **three acceptance cases** for *Testing AI Systems* (normal, boundary, adversarial) in `specs/lab-0904.yaml` or as pytest cases in `test_lab.py`. Goal: Derive a test pyramid from an AI system architecture.
...
```text
Read specs/lab-0904.yaml (or test_lab.py cases).
...
```text
/opsx:propose Add acceptance spec for lab 9.4 — Testing AI Systems
```
...
```text
/opsx:apply
python -m pytest labs/0904-*/test_lab.py -q
/opsx:archive
```
