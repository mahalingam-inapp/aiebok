...
- Book 6: Knowledge and Retrieval Systems, chapter 4
- Python 3.10+
...
1. **Write cases first** — Before changing `main.py`, write **three acceptance cases** for *Ranking and Context Selection* (normal, boundary, adversarial) in `specs/lab-0604.yaml` or as pytest cases in `test_lab.py`. Goal: Add reranking and measure quality versus latency.
...
```text
Read specs/lab-0604.yaml (or test_lab.py cases).
...
```text
/opsx:propose Add acceptance spec for lab 6.4 — Ranking and Context Selection
```
...
```text
/opsx:apply
python -m pytest labs/0604-*/test_lab.py -q
/opsx:archive
```
