...
- Book 12: Cloud and Enterprise AI Architecture, chapter 5
- Python 3.10+
...
1. **Write cases first** — Before changing `main.py`, write **three acceptance cases** for *Google Cloud and Portable Patterns* (normal, boundary, adversarial) in `specs/lab-1205.yaml` or as pytest cases in `test_lab.py`. Goal: Map the design to Google Cloud and identify the migration boundary.
...
```text
Read specs/lab-1205.yaml (or test_lab.py cases).
...
```text
/opsx:propose Add acceptance spec for lab 12.5 — Google Cloud and Portable Patterns
```
...
```text
/opsx:apply
python -m pytest labs/1205-*/test_lab.py -q
/opsx:archive
```
