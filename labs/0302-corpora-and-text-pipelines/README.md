...
- Book 3: Language and Representation, chapter 2
- Python 3.10+
...
1. **Write cases first** — Before changing `main.py`, write **three acceptance cases** for *Corpora and Text Pipelines* (normal, boundary, adversarial) in `specs/lab-0302.yaml` or as pytest cases in `test_lab.py`. Goal: Build a normalization pipeline and test it on multilingual and adversarial text.
...
```text
Read specs/lab-0302.yaml (or test_lab.py cases).
...
```text
/opsx:propose Add acceptance spec for lab 3.2 — Corpora and Text Pipelines
```
...
```text
/opsx:apply
python -m pytest labs/0302-*/test_lab.py -q
/opsx:archive
```
