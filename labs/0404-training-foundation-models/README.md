...
- Book 4: Transformers and Foundation Models, chapter 4
- Python 3.10+
...
1. **Write cases first** — Before changing `main.py`, write **three acceptance cases** for *Training Foundation Models* (normal, boundary, adversarial) in `specs/lab-0404.yaml` or as pytest cases in `test_lab.py`. Goal: Estimate compute and data requirements for a tiny language model.
...
```text
Read specs/lab-0404.yaml (or test_lab.py cases).
...
```text
/opsx:propose Add acceptance spec for lab 4.4 — Training Foundation Models
```
...
```text
/opsx:apply
python -m pytest labs/0404-*/test_lab.py -q
/opsx:archive
```
