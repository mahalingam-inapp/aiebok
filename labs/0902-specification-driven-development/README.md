...
- Book 9: AI Software and Product Engineering, chapter 2
- Python 3.10+
...
1. **Write cases first** — Before changing `main.py`, write **three acceptance cases** for *Specification-Driven Development* (normal, boundary, adversarial) in `specs/lab-0902.yaml` or as pytest cases in `test_lab.py`. Goal: Write executable examples before implementation.
...
```text
Read specs/lab-0902.yaml (or test_lab.py cases).
...
```text
/opsx:propose Add acceptance spec for lab 9.2 — Specification-Driven Development
```
...
```text
/opsx:apply
python -m pytest labs/0902-*/test_lab.py -q
/opsx:archive
```
