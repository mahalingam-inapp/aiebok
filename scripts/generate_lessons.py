...
SUPPLEMENTAL: list[tuple[str, str, str, str, list[str], str]] = [
    ...
    ("paper-reading", "Read a Paper Critically", "Extract claims, evidence, and limits.", "../books/13-multimodal-and-frontier-systems/06-how-to-track-the-frontier.md", ["ablations", "scaling laws", "reproduction"], "Summarize one frontier claim using the chapter checklist."),
    ("transformer-paper", "Transformer Deep Dive", "Connect attention mechanisms to code.", "../books/04-transformers-and-foundation-models/02-attention.md", ["multi-head attention", "position", "residual connections"], "Sketch one encoder block diagram from memory."),
    ("rag-paper", "RAG Deep Dive", "Ground generation with retrieved evidence.", "../books/06-knowledge-and-retrieval-systems/05-rag-generation-and-citations.md", ["RAG", "retrieval", "faithfulness"], "Identify one failure mode RAG does not fix."),
    ("rlhf-paper", "RLHF and Preferences", "Align models with human feedback.", "../books/11-training-serving-and-ai-operations/02-post-training-methods.md", ["SFT", "human evaluation", "instruction tuning"], "Contrast SFT-only vs preference-trained behavior."),
    ("agent-benchmarks", "Agent Benchmarks", "Interpret realistic agent evaluations.", "../books/08-agent-systems/06-operating-long-running-agents.md", ["benchmarks", "action spaces", "task success"], "Define success criteria for one agent task."),
    ("mcp-spec-lesson", "MCP Integration Patterns", "Standardize tool and resource access.", "../books/07-reasoning-and-tool-use/05-mcp-and-integration-protocols.md", ["MCP", "tool schemas", "portable interfaces"], "Compare MCP to ad-hoc REST tool wrappers."),
]
